...
describe('toNiceDomain', () => {
  ...
  const outputs = ['example.com', 'northsky.app', 'Northsky Social', '#123123123']
...
describe('toShortUrl', () => {
  const inputs = [
    'https://northsky.app',
    'https://northsky.app/3jk7x4irgv52r',
    'https://northsky.app/3jk7x4irgv52r2313y182h9',
    'https://very-long-domain-name.com/foo',
    'https://very-long-domain-name.com/foo?bar=baz#andsomemore',
  ]
  const outputs = [
    'northsky.app',
    'northsky.app/3jk7x4irgv52r',
    'northsky.app/3jk7x4irgv52...',
...
describe('toShareUrl', () => {
  const inputs = ['https://northsky.app', '/3jk7x4irgv52r', 'item/test/123']
  const outputs = [
    'https://northsky.app',
    'https://northsky.app/3jk7x4irgv52r',
    'https://northsky.app/item/test/123',
  ]
  ...
  const outputs = [
    {
      type: 'youtube_video',
      source: 'youtube',
      playerUri: 'https://northsky.app/iframe/youtube.html?videoId=videoId&start=0',
    },
    {
      type: 'youtube_video',
      source: 'youtube',
      playerUri: 'https://northsky.app/iframe/youtube.html?videoId=videoId&start=1',
    },
    {
      type: 'youtube_video',
      source: 'youtube',
...

    {
      ...
      isGif: true,
      hideDetails: true,
      playerUri: 'https://t.gifs.northsky.app/someID_AAAAM/someName.gif',
      dimensions: {
        width: 100,
        height: 100,
      },
...
describe('parseStarterPackHttpUri', () => {
  const baseUri = 'https://northsky.app/start'
  ...
  it('returns null when the route is not /start or /starter-pack', () => {
    const validHttpUri = 'https://northsky.app/start/haileyok.com/rkey'
    expect(parseStarterPackUri(validHttpUri)).toEqual({
      name: 'haileyok.com',
      rkey: 'rkey',
    })

    const validHttpUri2 = 'https://northsky.app/starter-pack/haileyok.com/rkey'
    expect(parseStarterPackUri(validHttpUri2)).toEqual({
      name: 'haileyok.com',
      rkey: 'rkey',
    })

    const invalidHttpUri = 'https://northsky.app/profile/haileyok.com/rkey'
